...
def _filtro_ref_ambas(df, sub_filtro=None, **kw):
    ...
    if sub_filtro == "sin_crudo":
        return df[
            df["TECHNOLOGY"].isin(TECNOLOGIAS_REFINERIAS_BAR_CAR)
            & df["FUEL"].isin(COMBUSTIBLES_REFINERIA_SIN_CRUDO)
        ]

    return df[
        df["TECHNOLOGY"].isin(TECNOLOGIAS_REFINERIAS_BAR_CAR)
        & df["FUEL"].isin(COMBUSTIBLES_REFINERIA_CON_CRUDO)
    ]
...
TECNOLOGIAS_FILTRO_RECURSOS_CARBON = {
    "MINCOA",
    "EXPCOA",
}

TECNOLOGIAS_EXCLUIR_COMBUSTIBLE_COA_RECURSOS_CARBON = {
    "EXPCOA",
}

COMBUSTIBLES_FILTRO_RECURSOS_CARBON = {
    "COA",
}
...
def _filtro_recursos_carbon(df, **kw):
    ...
    if "FUEL" in df.columns:
        return df[
            (df["TECHNOLOGY"].isin(TECNOLOGIAS_FILTRO_RECURSOS_CARBON))
            | (
                df["FUEL"].isin(COMBUSTIBLES_FILTRO_RECURSOS_CARBON)
                & ~df["TECHNOLOGY"].isin(
                    TECNOLOGIAS_EXCLUIR_COMBUSTIBLE_COA_RECURSOS_CARBON
                )
            )
    ...
    return df[df["TECHNOLOGY"].isin(TECNOLOGIAS_FILTRO_RECURSOS_CARBON)]
...
SUBFILTROS_RESIDENCIALES = {
    "CKN": TECNOLOGIAS_RESIDENCIALES_CKN,
    "WHT": TECNOLOGIAS_RESIDENCIALES_WHT,
    "AIR": TECNOLOGIAS_RESIDENCIALES_AIR,
    "REF": TECNOLOGIAS_RESIDENCIALES_REF,
    "ILU": TECNOLOGIAS_RESIDENCIALES_ILU,
    "TV": TECNOLOGIAS_RESIDENCIALES_TV,
    "FAN": TECNOLOGIAS_RESIDENCIALES_FAN,
    "WSH": TECNOLOGIAS_RESIDENCIALES_WSH,
    "OTH": TECNOLOGIAS_RESIDENCIALES_OTH,
}
...
def _filtro_residencial(df, sub_filtro=None, loc=None, **kw):
    ...
    if sub_filtro:
        mask &= df["TECHNOLOGY"].isin(SUBFILTROS_RESIDENCIALES[sub_filtro])
...
TECNOLOGIAS_INDUSTRIALES_AIR = [
    "DEMINDELCAIR_HIG",
    "DEMINDELCAIR_LOW",
    "DEMINDELCAIR_MID",
]

TECNOLOGIAS_INDUSTRIALES_REF = [
    "DEMINDELCREF_HIG",
    "DEMINDELCREF_LOW",
    "DEMINDELCREF_MID",
]
...
TECNOLOGIAS_INDUSTRIALES_ILU = [
    "DEMINDELCILU_HIG",
    "DEMINDELCILU_LOW",
    "DEMINDELCILU_MID",
]

TECNOLOGIAS_INDUSTRIALES_OTH = [
    "DEMINDCOAOTH_LOW",
    "DEMINDELCOTH_HIG",
    "DEMINDELCOTH_LOW",
    "DEMINDELCOTH_MID",
...
SUBFILTROS_INDUSTRIALES = {
    "BOI": TECNOLOGIAS_INDUSTRIALES_BOI,
    "FUR": TECNOLOGIAS_INDUSTRIALES_FUR,
    "MPW": TECNOLOGIAS_INDUSTRIALES_MPW,
    "AIR": TECNOLOGIAS_INDUSTRIALES_AIR,
    "REF": TECNOLOGIAS_INDUSTRIALES_REF,
    "ILU": TECNOLOGIAS_INDUSTRIALES_ILU,
    "OTH": TECNOLOGIAS_INDUSTRIALES_OTH,
}
...
def _filtro_industrial(df, sub_filtro=None, **kw):
    ...
    if sub_filtro:
        return df[df["TECHNOLOGY"].isin(SUBFILTROS_INDUSTRIALES[sub_filtro])]

    return df[df["TECHNOLOGY"].isin(TECNOLOGIAS_INDUSTRIALES)]
...
TECNOLOGIAS_TRANSPORTE_AVI = [
    "DEMTRAJETAVI",
    "DEMTRAJETSAFAVI",
]

TECNOLOGIAS_TRANSPORTE_BOT = [
    "DEMTRADSLBOT",
    "DEMTRAELCBOT",
    "DEMTRAGSLBOT",
]

TECNOLOGIAS_TRANSPORTE_SHP = [
    "DEMTRADSLSHP",
    "DEMTRAFOLSHP",
]

TECNOLOGIAS_TRANSPORTE_LDV = [
    "DEMTRADSLLDV",
    "DEMTRAELCLDV",
    "DEMTRAGSLLDV",
    "DEMTRAHDGLDV",
...
TECNOLOGIAS_TRANSPORTE_TCK_2CP = [
    "DEMTRADSLTCK_C2P",
    "DEMTRAELCTCK_C2P",
    "DEMTRAGSLTCK_C2P",
    "DEMTRANGSTCK_C2P",
...
TECNOLOGIAS_TRANSPORTE_TCK_CSG = [
    "DEMTRADSLTCK_CSG",
    "DEMTRAELCTCK_CSG",
    "DEMTRAHDGTCK_CSG",
    "DEMTRANGSTCK_CSG",
...
TECNOLOGIAS_TRANSPORTE_MET = [
    "DEMTRAELCMET",
]

SUBFILTROS_TRANSPORTE = {
    "CARRETERA": TECNOLOGIAS_TRANSPORTE_CARRETERA,
    "AVI": TECNOLOGIAS_TRANSPORTE_AVI,
    "BOT": TECNOLOGIAS_TRANSPORTE_BOT,
    "SHP": TECNOLOGIAS_TRANSPORTE_SHP,
    "LDV": TECNOLOGIAS_TRANSPORTE_LDV,
    "FWD": TECNOLOGIAS_TRANSPORTE_FWD,
    "BUS": TECNOLOGIAS_TRANSPORTE_BUS,
    "TCK_C2P": TECNOLOGIAS_TRANSPORTE_TCK_2CP,
    "TCK_CSG": TECNOLOGIAS_TRANSPORTE_TCK_CSG,
    "MOT": TECNOLOGIAS_TRANSPORTE_MOT,
    "MIC": TECNOLOGIAS_TRANSPORTE_MIC,
    "TAX": TECNOLOGIAS_TRANSPORTE_TAX,
    "STT": TECNOLOGIAS_TRANSPORTE_STT,
    "MET": TECNOLOGIAS_TRANSPORTE_MET,
}
...
def _filtro_transporte(df, sub_filtro=None, **kw):
    ...
    if sub_filtro:
        return df[df["TECHNOLOGY"].isin(SUBFILTROS_TRANSPORTE[sub_filtro])]
...
TECNOLOGIAS_TERCIARIO_ACL = [
    "DEMTERELCACL_HIG",
    "DEMTERELCACL_LOW",
    "DEMTERELCACL_MID",
]

TECNOLOGIAS_TERCIARIO_AIR = [
    "DEMTERELCAIR_CEN_HIG",
    "DEMTERELCAIR_CEN_LOW",
    "DEMTERELCAIR_CEN_MID",
    "DEMTERELCAIR_HIG",
...
TECNOLOGIAS_TERCIARIO_DAT = [
    "DEMTERELCDATA",
]

TECNOLOGIAS_TERCIARIO_FAN = [
    "DEMTERELCFAN_HIG",
    "DEMTERELCFAN_LOW",
    "DEMTERELCFAN_MID",
]

TECNOLOGIAS_TERCIARIO_ILU = [
    "DEMTERELCILU_CIA",
    "DEMTERELCILU_HAL",
    "DEMTERELCILU_HIG",
    "DEMTERELCILU_LFC",
...
TECNOLOGIAS_TERCIARIO_MPW = [
    "DEMTERELCMPW_HIG",
    "DEMTERELCMPW_LOW",
    "DEMTERELCMPW_MID",
]

TECNOLOGIAS_TERCIARIO_REF = [
    "DEMTERELCREF_AUC_HIG",
    "DEMTERELCREF_AUC_LOW",
    "DEMTERELCREF_AUC_MID",
    "DEMTERELCREF_CEN_HIG",
...
SUBFILTROS_TERCIARIO = {
    "ACL": TECNOLOGIAS_TERCIARIO_ACL,
    "AIR": TECNOLOGIAS_TERCIARIO_AIR,
    "CKN": TECNOLOGIAS_TERCIARIO_CKN,
    "DAT": TECNOLOGIAS_TERCIARIO_DAT,
    "FAN": TECNOLOGIAS_TERCIARIO_FAN,
    "ILU": TECNOLOGIAS_TERCIARIO_ILU,
    "MPW": TECNOLOGIAS_TERCIARIO_MPW,
    "REF": TECNOLOGIAS_TERCIARIO_REF,
    "OTH": TECNOLOGIAS_TERCIARIO_OTH,
}
...
def _filtro_terciario(df, sub_filtro=None, **kw):
    ...
    if sub_filtro:
        return df[df["TECHNOLOGY"].isin(SUBFILTROS_TERCIARIO[sub_filtro])]

    return df[df["TECHNOLOGY"].isin(TECNOLOGIAS_TERCIARIO)]
...
def _filtro_construccion(df, sub_filtro=None, **kw):
    return df[df["TECHNOLOGY"].isin(TECNOLOGIAS_CONSTRUCCION)]
...
def _filtro_agroforestal(df, sub_filtro=None, **kw):
    return df[df["TECHNOLOGY"].isin(TECNOLOGIAS_AGROFORESTAL)]
...
def _filtro_mineria(df, sub_filtro=None, **kw):
    return df[df["TECHNOLOGY"].isin(TECNOLOGIAS_MINERIA)]
...
def _filtro_coquerias(df, sub_filtro=None, **kw):
    return df[df["TECHNOLOGY"].isin(TECNOLOGIAS_COQUERIAS)]
...
def _filtro_demanda_por_combustible(df, sub_filtro=None, **kw):
    ...
    df = df[df["TECHNOLOGY"].isin(TECNOLOGIAS_DEMANDA_TODOS)]

    if sub_filtro:
        if sub_filtro not in FUEL_VALIDOS_DEMANDA:
            return df.iloc[0:0]
...
TECNOLOGIAS_DEMANDA_LIQUIDOS_TODOS = [
    "DEMRESBGSCKN_MID_RUR",
    "DEMRESELCAIR_HIG",
    "DEMRESELCAIR_LOW",
    "DEMRESELCAIR_PAR_HIG_RUR",
...
def _filtro_consumo_liquidos(df, **kw):
    ...
    df = df[df["TECHNOLOGY"].isin(TECNOLOGIAS_DEMANDA_LIQUIDOS_TODOS)]

    return df[df["FUEL"].isin(FUELS_LIQUIDOS)]


TECNOLOGIAS_DEMANDA_LIQUIDOS_TODOS_2 = [
    "DEMRESBGSCKN_MID_RUR",
    "DEMRESELCAIR_HIG",
    "DEMRESELCAIR_LOW",
    "DEMRESELCAIR_PAR_HIG_RUR",
...
def _filtro_liquidos_total(df, **kw):
    ...
    return df[
        df["TECHNOLOGY"].isin(TECNOLOGIAS_DEMANDA_LIQUIDOS_TODOS_2)
        & df["FUEL"].isin(FUELS_LIQUIDOS)
    ]


TECNOLOGIAS_DEMANDA_EXPORTACION_LIQUIDOS_TODOS = [
    "DEMRESBGSCKN_MID_RUR",
    "DEMRESELCAIR_HIG",
    "DEMRESELCAIR_LOW",
    "DEMRESELCAIR_PAR_HIG_RUR",
...
def _filtro_demanda_exportaciones_liquidos(df, **kw):
    ...
    return df[
        df["TECHNOLOGY"].isin(TECNOLOGIAS_DEMANDA_EXPORTACION_LIQUIDOS_TODOS)
        & df["FUEL"].isin(FUELS_LIQUIDOS)
    ]
