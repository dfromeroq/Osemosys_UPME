...
DISPLAY_NAMES: dict[str, str] = {
    ...
    "MINONW": "Pot. Eól.Ter.",
    "MINOPL": "Aceite de Palma",
    "MINROR": "Pot. Hidro (ROR)",
    "MINSGC": "Caña de Azúcar",
    "MINBAG": "Bagazo de Caña",
    "MINBG": "Bagazo de Caña",
    "MINSOL": "Pot. Solar FV",
    "MINSOL_RTP": "Pot. Solar Techo",
    "MINURN": "Prod. Uranio",
    "MINWAS": "Residuos Sólidos",
    "MINWAS_ORG": "Residuos Orgánicos",
    ...
    "DEMINDHDGBOI": "Industria uso directo",
    "DEMINDHDGBOI_HIG": "Industria uso directo",
    "DEMINDHDGBOI_LOW": "Industria uso directo",
    "DEMINDHDGFUR": "Industria uso directo",
    ...
    "DEMTRAHDGSTT": "Transporte pesado",
    "DEMTRAHDGTAX": "Tra. H₂ Taxi",
    "DEMTRAHDGTCK": "Tra. FCEV Camión",
    "DEMTRAHDGTCK_CSG": "Transporte pesado",
    ...
    "UPSSMR": "Hidrógeno Gris",
    "UPSSMRCCS": "Hidrógeno Azul",
    "UPSSAF": "SAF",
