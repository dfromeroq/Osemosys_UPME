...
export function ModelParameterDefaultsPage() {
  ...
  const isReadOnly = viewVersionId != null && activeVersionId != null && viewVersionId !== activeVersionId;
  ...
  return (
    <section className="pageSection" style={{ display: "grid", gap: 16 }}>
      <header>
        <h1 className="pageTitle">Defaults del modelo OSeMOSYS</h1>
        <p className="pageLead" style={{ maxWidth: 720 }}>
